...
# # Update the file path to the actual location of the file on your system
# file_path = r"C:\Users\mayan\OneDrive\Desktop\jarviss\contacts.csv"  # Update this path as needed
...
# print("Inserted rows count:", len(rows))
# con.close()
